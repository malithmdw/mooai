...
application authorization". `authorization.py` is the centralized RBAC
policy (`Permission`, `AuthorizationPolicy`) — see also
`docs/authorization.md`.

POC NOTE: authentication is intentionally hardcoded for this proof of
concept (see `auth.py`, `docs/authentication.md`). Keycloak/OAuth
integration is explicitly out of scope until a later milestone — do not
